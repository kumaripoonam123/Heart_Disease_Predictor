...
# Correct the placeholder with the actual path
location = r'C:\Users\poona\Downloads\Heart Disease Predictor\Heart Disease Predictor main'

# Join the location with the filename
